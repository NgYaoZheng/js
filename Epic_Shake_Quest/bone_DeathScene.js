class bone_DeathScene extends Phaser.Scene {
  constructor() {
    super({ key: "bone_DeathScene" });
  }

  preload() {
    this.load.image("bone_Death", "assets/bone_Death.png");
  }

  create() {
    console.log("bone_DeathScene");

    this.scene.stop("showInventory");

    this.add.image(0, 0, "bone_Death").setOrigin(0, 0).setScale(1);
