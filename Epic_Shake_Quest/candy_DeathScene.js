class candy_DeathScene extends Phaser.Scene {
  constructor() {
    super({ key: "candy_DeathScene" });
  }

  preload() {
    this.load.image("candy_Death", "assets/candy_Death.png");
  }

  create() {
    console.log("candy_DeathScene");

    this.scene.stop("showInventory");

    this.add.image(0, 0, "candy_Death").setOrigin(0, 0).setScale(1);
