class cheese_DeathScene extends Phaser.Scene {
  constructor() {
    super({ key: "cheese_DeathScene" });
  }

  preload() {
    this.load.image("cheese_Death", "assets/cheese_Death.png");
  }

  create() {
    console.log("cheese_DeathScene");

    this.scene.stop("showInventory");

    this.add.image(0, 0, "cheese_Death").setOrigin(0, 0).setScale(1);
