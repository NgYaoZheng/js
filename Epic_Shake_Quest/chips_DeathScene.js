class chips_DeathScene extends Phaser.Scene {
  constructor() {
    super({ key: "chips_DeathScene" });
  }

  preload() {
    this.load.image("chips_Death", "assets/chips_Death.png");
  }

  create() {
    console.log("chips_DeathScene");

    this.scene.stop("showInventory");

    this.add.image(0, 0, "chips_Death").setOrigin(0, 0).setScale(1);
