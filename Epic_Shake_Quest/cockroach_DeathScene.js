class cockroach_DeathScene extends Phaser.Scene {
  constructor() {
    super({ key: "cockroach_DeathScene" });
  }

  preload() {
    this.load.image("cockroach_Death", "assets/cockroach_Death.png");
  }

  create() {
    console.log("cockroach_DeathScene");

    this.scene.stop("showInventory");

    this.add.image(0, 0, "cockroach_Death").setOrigin(0, 0).setScale(1);
