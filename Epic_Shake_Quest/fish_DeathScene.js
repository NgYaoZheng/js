class fish_DeathScene extends Phaser.Scene {
  constructor() {
    super({ key: "fish_DeathScene" });
  }

  preload() {
    this.load.image("fish_Death", "assets/fish_Death.png");
  }

  create() {
    console.log("fish_DeathScene");

    this.scene.stop("showInventory");

    this.add.image(0, 0, "fish_Death").setOrigin(0, 0).setScale(1);
