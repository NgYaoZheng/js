class rot_Banana_DeathScene extends Phaser.Scene {
  constructor() {
    super({ key: "rot_Banana_DeathScene" });
  }

  preload() {
    this.load.image("rotten", "assets/rotten_Death.png");
  }

  create() {
    console.log("rot_Banana_DeathScene");

    this.scene.stop("showInventory");

    this.add.image(0, 0, "rotten").setOrigin(0, 0).setScale(1);
