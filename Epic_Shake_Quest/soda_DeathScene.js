class soda_DeathScene extends Phaser.Scene {
  constructor() {
    super({ key: "soda_DeathScene" });
  }

  preload() {
    this.load.image("soda_Death", "assets/soda_Death.png");
  }

  create() {
    console.log("soda_DeathScene");

    this.scene.stop("showInventory");

    this.add.image(0, 0, "soda_Death").setOrigin(0, 0).setScale(1);
